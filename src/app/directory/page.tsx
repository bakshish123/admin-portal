    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="mb-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        <input
          ...
          className="p-3 border border-white rounded bg-transparent text-white focus:outline-none focus:border-lilac-600 focus:ring-lilac-600"
        />
        <input
          type="text"
          name="jobTitle"
      ...
      <div className="text-center mb-8">
        <button
          ...
          className="px-6 py-2 bg-blue-400 bg-opacity-70 text-white rounded hover:bg-opacity-90 transition duration-300"
        >
          Search
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {alumni.map((alumniMember) => (
          <div
            ...
            className="bg-blue-400 bg-opacity-30 backdrop-blur-lg shadow-lg rounded-lg p-6 hover:shadow-xl transition-shadow transform hover:-translate-y-1 duration-300"
          >
